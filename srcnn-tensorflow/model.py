...
class SRCNN(object):
  ...
  def build_model(self):
    ...
    self.weights = {
      'w1': tf.Variable(initial_value=weights_conv1, name='w1'),
      'w2': tf.Variable(initial_value=weights_conv2, name='w2'),
      'w3': tf.Variable(initial_value=weights_conv3, name='w3')
    }
    ...
    self.biases = {
      'b1': tf.Variable(initial_value=biases_conv1, name='b1'),
      'b2': tf.Variable(initial_value=biases_conv2, name='b2'),
      'b3': tf.Variable(initial_value=biases_conv3, name='b3')
    }
